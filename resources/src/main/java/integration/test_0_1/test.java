...
public class test implements TalendJob {
	...
	private final String projectName = "INTEGRATION";
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_INTEGRATION_test = new byte[0];
		static byte[] commonByteArray_INTEGRATION_test = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_INTEGRATION_test.length) {
					if (length < 1024
							&& commonByteArray_INTEGRATION_test.length == 0) {
						commonByteArray_INTEGRATION_test = new byte[1024];
					} else {
						commonByteArray_INTEGRATION_test = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_INTEGRATION_test, 0, length);
				strReturn = new String(commonByteArray_INTEGRATION_test, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_INTEGRATION_test) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test.class.getClassLoader()
					.getResourceAsStream(
							"integration/test_0_1/contexts/" + contextStr
									+ ".properties");
...
/************************************************************************************************
 * 34011 characters generated by Talend Data Management Platform on the 10 avril
 * 2019 16:52:28 CEST
 ************************************************************************************************/
